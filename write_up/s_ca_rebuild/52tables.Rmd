...
quants = rbind(cbind(round(reb[[1]]$acl_matrix[1:4, 2:9], 2), round(reb[[4]]$acl_matrix[1:4, 10], 2)),
               c(reb[[1]]$rebuild_quants$SPR[1:8], reb[[4]]$rebuild_quants$SPR[9]),
               c(reb[[1]]$rebuild_quants$Ttarget[1:8], reb[[4]]$rebuild_quants$Ttarget[9]),
               rep(reb[[1]]$tmax, length(reb[[1]]$rebuild_quants$Ttarget)),
               c(reb[[1]]$rebuild_quants$Prebuild[1:8], reb[[4]]$rebuild_quants$Prebuild[9])) # Prob by Tmax
...
out = as.data.frame(cbind(round(reb[[1]]$prob_matrix[1:35, 1:9],3), round(reb[[4]]$prob_matrix[1:35, 10], 3)))
...
out = as.data.frame(cbind(round(reb[[1]]$acl_matrix[1:35, 1:9],2), round(reb[[4]]$acl_matrix[1:35, 10],2)))
colnames(out)[10] = "ABC Rule"
...
out = as.data.frame(cbind(round(reb[[1]]$ofl_matrix[1:35, 1:9],2), round(reb[[4]]$ofl_matrix[1:35, 10],2)))
colnames(out)[10] = "ABC Rule"
...
out = as.data.frame(cbind(round(reb[[1]]$relativeb_matrix[1:35,1:9],2), round(reb[[4]]$relativeb_matrix[1:35, 10], 2)))
colnames(out)[10] = "ABC Rule"
