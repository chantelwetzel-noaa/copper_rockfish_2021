...
There were 12 estimated parameters in the base model. These included 1 parameter for $R_0$, 1 for estimated added variance for the `r hkl` index of abundance, and 10 parameters for selectivity. The estimation of annual recruitment deviations was explored but were not included in the base model due to correlation with high catches during periods of estimated low stock abundance.
