...
\include{tex_tables/sensitivities_1_new.tex}

\newpage

\include{tex_tables/sensitivities_2_new.tex}
...
\tagstructbegin{tag=Figure,alttext={NWFSC Hook and Line survey sample sites inside and outside the CCA and site with observations of copper rockfish.}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={Lengths observations by depth in the NWFSC Hook and Line survey data.}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={Diagnostics for the binomial generalized-linear model.}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={All available survey length-at-weight data with sex specific estimated fits.}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={Length-at-age for non-randomly sampled larger fish observed by the NWFSC Hook and Line and WCGBT surveys.}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={Length-at-age for non-randomly sampled larger fish observed by the NWFSC Hook and Line and WCGBT surveys and young fish from Lea.}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={Copper and quillback rockfish potential depth range off California in red hatched polygon, hard substrate occurring within the potential range in pink, MPAs in dark blue outline, and the CCAs in light blue.}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={Copper and quillback rockfish potential depth range in red hatched polygon, hard substrate occurring within the potential range in pink and MPAs in dark blue outline between the Oregon/California border and Point Arena, California.}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={Copper and quillback rockfish potential depth range in red hatched polygon, hard substrate occurring within the potential range in pink and MPAs in dark blue outline between Point Arena and Pigeon Point, California.}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={Copper and quillback rockfish potential depth range in red hatched polygon, hard substrate occurring within the potential range in pink and MPAs in dark blue outline between Pigeon Point and Point Conception, California.}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={. Copper rockfish potential depth range in red hatched polygon, hard substrate occurring within the potential range in pink, MPAs in dark blue outline, and the CCA in light blue between the Point Conception, California and the U.S./Mexican border.   .}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={Percent composition of copper rockfish length frequency in 5 cm size classes for each 10 fm depth bin from ROV observations south of Point Conception in reference locations where fishing for groundfish is allowed.}}\tagmcbegin{tag=Figure}
...
\tagstructbegin{tag=Figure,alttext={Percent composition of copper rockfish length frequency in 5 cm size classes for each 10 fm depth bin from ROV observations south of Point Conception in marine protected areas where fishing for groundfish is prohibited.}}\tagmcbegin{tag=Figure}
