...
The 50 percent size-at-maturity was estimated at `r round(model$MGparmAdj[,"Mat50%_Fem_GP_1"][1], 1)` cm and slope of `r round(model$MGparmAdj$Mat_slope_Fem_GP_1[1], 2)` with maturity asymptoting to 1.0 for larger fish (Figure \ref{fig:maturity}). This area specific maturity-at-length estimate is relatively similar to the biological maturity curve assumed for `r spp` north of Point Conception based on the work of Hannah [-@hannah_length_2014] which estimated the 50 percent size-at-maturity of 34.8 cm and slope of -0.60.  
