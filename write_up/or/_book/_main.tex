...
\hypersetup{
  pdftitle={Copper Rockfish (Sebastes caurinus) along the Oregon US West coast in 2020},
  pdflang={en},
  hidelinks,
...
\date{}
\newcommand{\trTitle}{Copper Rockfish (\emph{Sebastes caurinus}) along the Oregon US West coast in 2020}
...
\noindent
\begin{center}
\title{Copper Rockfish (\emph{Sebastes caurinus}) along the Oregon US West coast in 2020}
% \textnormal{\MakeTextUppercase{\trTitle{}}}
\vspace{1.5cm}
{\Large\textbf\newline{Copper Rockfish (\emph{Sebastes caurinus}) along the Oregon US West coast in 2020}}
\vfill
by\\
...
This assessment reports the status of Copper Rockfish (\emph{Sebastes caurinus}) off the Oregon US West coast using data through xxxx.
