...
table_format(x = out,
             caption = "The OFL (mt) and ACL (mt) for the north nearshore complex, the species specific OFL and ACL contribution for copper rockfish, the copper rockfish ACL allocated to Oregon, and the total removals (mt).",
             label = "ofl",
             align = 'l',
             col_names = col_names)
