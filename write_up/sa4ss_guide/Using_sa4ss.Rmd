...
# Tips & Tricks
If you are creating an area-specific assessment document for species you may want to use the same text across multiple documents.  This can be easily done:

```r
# Directory where the document is being rendered:
wd = "C:/Assessments/2021/copper_rockfish_2021/write_up/wa"

# Directory where general text is available
other_wd = "C:/Assessments/2021/copper_rockfish_2021/write_up/general_text"
