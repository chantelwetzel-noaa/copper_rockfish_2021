...
\hypersetup{
  pdftitle={Copper Rockfish (Sebastes caurinus) along the US West coast in 2020},
  pdflang={en},
  hidelinks,
...
\date{}
\newcommand{\trTitle}{Copper Rockfish (\emph{Sebastes caurinus}) along the US West coast in 2020}
...
\noindent
\begin{center}
\title{Copper Rockfish (\emph{Sebastes caurinus}) along the US West coast in 2020}
% \textnormal{\MakeTextUppercase{\trTitle{}}}
\vspace{1.5cm}
{\Large\textbf\newline{Copper Rockfish (\emph{Sebastes caurinus}) along the US West coast in 2020}}
\vfill
by\\
...
\addcontentsline{toc}{section}{Stock}
...
\addcontentsline{toc}{section}{Landings}
...
\caption{\label{tab:test}Catches!}
\centering
...
Alterantive formatting using function format\_table:

\leavevmode\tagmcend\tagstructend\par
\begin{table}[!h]

\caption{\label{tab:mortality}Formatted catches}
\centering
...
\section*{Data and Assessment}\label{data-and-assessment}}
\addcontentsline{toc}{section}{Data and Assessment}
...
\section*{Stock Biomass}\label{stock-biomass}}
\addcontentsline{toc}{section}{Stock Biomass}
...
\caption{\label{tab:ssb}Estimated spawning output and relative stock status (depletion) and the 95 percent confidence intervals (CI).}
\centering
...
\addcontentsline{toc}{section}{Recruitment}
...
\section*{Exploitation Status}\label{exploitation-status}}
\addcontentsline{toc}{section}{Exploitation Status}
...
\addcontentsline{toc}{section}{Reference Points}
...
\section*{Management Performance}\label{management-performance}}
\addcontentsline{toc}{section}{Management Performance}
...
\section*{Unresolved Problems and Major Uncertainties}\label{unresolved-problems-and-major-uncertainties}}
\addcontentsline{toc}{section}{Unresolved Problems and Major Uncertainties}
...
\section*{Decision Table}\label{decision-table}}
\addcontentsline{toc}{section}{Decision Table}
...
\addcontentsline{toc}{section}{Research and Data Needs}
