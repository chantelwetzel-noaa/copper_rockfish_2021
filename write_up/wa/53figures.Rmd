...
```{r, echo=FALSE, results='asis'}
sss_loc = "C:/Assessments/2021/copper_rockfish_2021/models/sss/plots"

add_figure(
filein = file.path(sss_loc, "wa_7.7_base_depl_60_Priors.png"), 
...
```{r, echo=FALSE, results='asis'}
add_figure(
filein = file.path(sss_loc, "wa_7.7_base_depl_60_quants.png"), 
...
```{r, echo=FALSE, results='asis'}
add_figure(
filein = file.path(sss_loc, "wa_7.7_base_depl_40_Priors.png"), 
caption = "Prior distributions for parameter input for SSS",
label = "sss-prior-40")
```
...
```{r, echo=FALSE, results='asis'}
add_figure(
filein = file.path(sss_loc, "wa_7.7_base_depl_40_quants.png"), 
