...
\toprule
\multicolumn{3}{c}{ } & \multicolumn{2}{c}{log($R_0$)=1.89} & \multicolumn{2}{c}{log($R_0$)=2.03} & \multicolumn{2}{c}{log($R_0$)=2.21} \\
...
P*=	&	2026	&	1.89	&	2.26	&	0.340	&	3.39	&	0.443	&	5.00	&	0.545	\\
0.45&	2027	&	1.90	&	2.29	&	0.344	&	3.43	&	0.448	&	5.05	&	0.551	\\
