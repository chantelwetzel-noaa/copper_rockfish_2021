...
table_format(x = out,
             caption = "The complex level OFL (mt) and ACL (mt) for Nearshore Rockfish north and south of 40.10 Latitude N., the copper rockfish OFL (mt) and ACL (mt) contributions, the total ACL (mt) allocated to California, and the total removals (mt) from north of Point Conception.",
             label = "ofl",
             landscape = TRUE,
             align = 'l',
             custom_width = TRUE,
