...
Dir.in <-"C:/Assessments/2021/copper_rockfish_2021/models/sss/or/10.5_base_logistic_depl_47"
Dir.in <-"C:/Assessments/2021/copper_rockfish_2021/models/sss/or/10.5_base_domed_depl_57"
Dir.in <-"C:/Assessments/2021/copper_rockfish_2021/models/sss/or/10.5_base_depl_75"
Dir.in <-"C:/Assessments/2021/copper_rockfish_2021/models/sss/or/10.5_base_tight_sd_depl_75"

SSS.BH <- SSS(filepath= Dir.in, # location to run the model
              file.name=c("2021_or_copper.dat","2021_or_copper.ctl"), # data and ctl file names
              reps = 1000, # number of model runs
              seed.in = 19, # seed number
              Dep.in = c(2, 0.75, 0.10), # c(distribution shape, mean, sd)
...
library(sa4ss)
dep = 75 #57 # 47
selex = "logistic" ; dep = 47
selex = "domed" ; dep = 57
base = paste0("10.5_base_", selex, "_depl_", dep)
base = paste0("10.5_base_depl_", dep)
base = paste0("10.5_base_tight_sd_depl_", dep)
dir = "C:/Assessments/2021/copper_rockfish_2021/models/sss/or"
...
file = paste0("C:/Assessments/2021/copper_rockfish_2021/write_up/or/tex_tables/sss_", dep,".tex"))
