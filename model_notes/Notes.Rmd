...
- Pretty consistent trends across explorations with exception of domed-selectivity. No support for dome in early selex block.
...
![M profiles.\label{fig:Mprofile-wa}](//nwcfile/FRAM/Assessments/CurrentAssessments/DataModerate_2021/Quillback_Rockfish/models/or/3_0_baseR0profile_profile_NatM_p_1_Fem_GP_1/piner_panel_NatM_p_1_Fem_GP_1.png){width=50% height=50%}
...
- Commercial comps have information in recdevs (due to when excluding them, comm selex shifts far left)
...
- Much more left shifted selectivity curve for recreational fishery than in other states
