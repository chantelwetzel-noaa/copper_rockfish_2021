...
- Recdevs high early, low recent: driven lack of small fish and increasing mean size in later years and . Selectivity is right shifted too.
...
- Choice of data weighting makes a difference. Interesting to think of when have such limited data to weight.
...
- "Base" model (3_0_base)
- Include recdevs, include block starting at 1999
- Very strong recruitment pulses driven by comps. 2012 pulse driven by most recent years, in both rec and comm. Other pulses evident in compositions across years. Recent pulse "saves" population (i.e. removing 2017-2020 comps cause population to decline)
- Given strong recruitment, population turns around dramatically. Is this reasonable for a population living to 90?
- Pretty consistent trends across explorations with expection of domed-selectivity. Also, no support for dome in early selex block.
- Included ages as ghost fleet, and fitting. Model with ages compares reasonably. Suggests some support of length data by ages. 
- Continued evidence for sigmaR = 0.9 but not doing. Only reason is that it "seems" large. Where to explore what is reasonable?
