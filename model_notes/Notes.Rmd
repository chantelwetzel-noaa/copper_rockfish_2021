...
![R0 profile for CA South copper rockfish.\label{fig:r0-sca}](C:/Assessments/2021/copper_rockfish_2021/models/ca_s_pt_c/7.1_data_rec_len_add_trawl_profile_SR_LN(R0)/R0_profile_ca_s_pt_c.png){width=50% height=50%}

![Parameter profile for CA South copper rockfish.\label{fig:para-sca}](C:/Assessments/2021/copper_rockfish_2021/models/ca_s_pt_c/7.1_data_rec_len_add_trawl_profile_SR_LN(R0)/parameter_panel_SR_LN(R0).png){width=50% height=50%}
...
![R0 profile for CA North copper rockfish.\label{fig:r0-nca}](C:/Assessments/2021/copper_rockfish_2021/models/ca_n_pt_c/5.1_data_rec_len_trawl_survey_profile_SR_LN(R0)/R0_profile_ca_n_pt_c.png){width=50% height=50%}

![Parameter profile for California North copper rockfish.\label{fig:para-nca}](C:/Assessments/2021/copper_rockfish_2021/models/ca_n_pt_c/5.1_data_rec_len_trawl_survey_profile_SR_LN(R0)/parameter_panel_SR_LN(R0).png){width=50% height=50%}
...
![R0 profile for Oregon copper rockfish.\label{fig:r0-or}](C:/Assessments/2021/copper_rockfish_2021/models/or/2.4_recdevs_early_est_p1_only_block_profile_SR_LN(R0)/R0_profile_or.png){width=50% height=50%}


![Parameter profile for Oregon copper rockfish.\label{fig:para-or}](C:/Assessments/2021/copper_rockfish_2021/models/or/2.4_recdevs_early_est_p1_only_block_profile_SR_LN(R0)/parameter_panel_SR_LN(R0).png){width=50% height=50%}
...
![R0 profile for Washington copper rockfish.\label{fig:r0-wa}](C:/Assessments/2021/copper_rockfish_2021/models/wa/5.1.1_selex_cv_fixed_profile_SR_LN(R0)/R0_profile_wa.png){width=50% height=50%}

![Parameter profile for Washington copper rockfish.\label{fig:para-wa}](C:/Assessments/2021/copper_rockfish_2021/models/wa/5.1.1_selex_cv_fixed_profile_SR_LN(R0)/parameter_panel_SR_LN(R0).png){width=50% height=50%}
